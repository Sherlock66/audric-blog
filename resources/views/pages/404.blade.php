...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('master/css/pages/404.css')}}" />
...
<body>
    ...
    <div class="hgroup">
        ...
        <a href="index.html" class="btn btn-responsive btn-default button-alignment">Home
        </a>
    </div>
    <!-- global js -->
    ...
    <script src="{{asset('master/js/404.js')}}"></script>
